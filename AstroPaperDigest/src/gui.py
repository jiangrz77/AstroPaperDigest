...
.nav-star-5{color:#f4b400}.nav-star-4{color:#27ae60}.nav-star-3{color:#2563eb}.nav-star-2{color:#8b5cf6}.nav-star-1{color:#95a5a6}
...
.loading-area .msg{color:#555;font-size:15px;margin-bottom:8px;white-space:pre-line}
